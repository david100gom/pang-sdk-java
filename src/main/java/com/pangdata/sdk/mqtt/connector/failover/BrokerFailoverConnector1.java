...
public class BrokerFailoverConnector1 extends AbstractBrokerConnectorV1 {
  private final static Logger logger = LoggerFactory.getLogger(BrokerFailoverConnector1.class);
  ...
  public BrokerFailoverConnector1(String threadName, String clientId) {
    this(threadName, null, null, clientId);
  }
  
  public BrokerFailoverConnector1(String threadName, String username, String passwd, String clientId) {
