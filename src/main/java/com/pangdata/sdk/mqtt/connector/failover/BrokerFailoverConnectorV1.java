...
import com.pangdata.sdk.mqtt.connector.AbstractBrokerConnector;
import com.pangdata.sdk.mqtt.connector.AbstractBrokerConnectorV1;

public class BrokerFailoverConnectorV1 extends AbstractBrokerConnectorV1 {
  private final static Logger logger = LoggerFactory.getLogger(BrokerFailoverConnectorV1.class);
  ...
  public BrokerFailoverConnectorV1(String threadName, String clientId) {
    this(threadName, null, null, clientId);
  }
  
  public BrokerFailoverConnectorV1(String threadName, String username, String passwd, String clientId) {
