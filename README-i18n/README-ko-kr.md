...
Pang Data SDK 는 **pang.properties**가 java 클래스패스 경로에 있는 것을 요구합니다. 이 파일은 Pangdata.com의 인증을 위해 **username**과 **user key** 을 가지고 있습니다.
